...
- **Earnings** — log income by date and source, with a running monthly total
- **Monthly Summary** — total spent this month, entry count, average per
  entry, a day-by-day bar breakdown, and an Earnings vs. Spending vs. Debt
  comparison with a net-for-the-month figure
...
- **Always-visible status strip** — today's total, this month's total,
  this month's earnings, and your net debt position, at the top of every tab
